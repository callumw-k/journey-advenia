...
export default function PrivacyPolicy() {
  return (
    <Layout>
      <Wrapper>
        <h3>- Updated March, 2021</h3>
        <p>
          This following document sets forth the Privacy Policy for the Aiden
          Kinder website, http://aidenkinder.com/.
        </p>
        <p>
          Aiden Kinder is committed to providing you with the best possible
          customer service experience. Aiden Kinder is bound by the Privacy Act
        ...
        <p>
          ...
          providing personal information, however, for access to future Aiden
          Kinder customer support features you are required to submit personally
          identifiable information. This may include but not limited to a unique
          username and password, or provide sensitive information in the
        ...
        <p>
          ...
          they need to deliver the service. Aiden Kinder takes reasonable steps
          to ensure that these organisations are bound by confidentiality and
        ...
        <p>
          Aiden Kinder reserves the right to make amendments to this Privacy
          Policy at any time. If you have objections to the Privacy Policy, you
        ...
        <p>
          ...
          reasons. Aiden Kinder reserves the right to charge a fee for searching
          for, and providing access to, your information on a per request basis.
        </p>
        <h3> Contacting us</h3>
        <p>
          Aiden Kinder welcomes your comments regarding this Privacy Policy. If
          you have any questions about this Privacy Policy and would like
          further information, please contact us by any of the following means
          during business hours Monday to Friday.
        </p>
        <p> Email: support@aidenkinder.com</p>
      </Wrapper>
    </Layout>
  );
}
